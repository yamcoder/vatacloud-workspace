...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/FO3jOOifer)
...
```sh
npx nx serve vatacloud-demo
```

To create a production bundle:

```sh
npx nx build vatacloud-demo
```

To see all available targets to run for a project, run:

```sh
npx nx show project vatacloud-demo
```
